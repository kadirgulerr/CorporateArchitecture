...
using CorporateArchitecture.Bll.DependencyResolvers.Autofac;
using CorporateArchitecture.Dal.Abstract;
using CorporateArchitecture.Dal.Concrete.EntityFramework;
using CorporateArchitecture.WebUI.ExtensionMethods;
...
namespace CorporateArchitecture.WebUI
{
    public class Startup
    {
        ...
        {
            SetDI.DependencyServices(services);
